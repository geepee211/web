...
if(isset($_GET['rs_id']))
	...
	if($opr=="del")
{
	$del_sql=mysql_query("DELETE FROM students WHERE id=$id");
	if($del_sql)
...
<section id="contact-page">
        <div class="container">
            <div class="center"> <br>       
                <h4>Manage Students&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="students_entry.php" style="background-color:#4D4DFF;">Create Students Account</a></h4>
            </div>
	...
	while  (@$row=mysql_fetch_array($run)) {
	   ...
	   $sNationality = $row[6];
	    ...
	    $studentAddress = $row[7];
			...
			<td><a href="?tag=manageStudents&opr=del&rs_id=<?php echo $row['id'];?>" title="Delete"><img src="./images/delete.png" /></a></td>
